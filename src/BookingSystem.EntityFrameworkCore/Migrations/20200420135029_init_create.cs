        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    TenantId = table.Column<int>(nullable: false),
                    JetType = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DynamicParameterValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DynamicParameterValues_DynamicParameters_DynamicParameterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntityDynamicParameters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntityDynamicParameters_DynamicParameters_DynamicParameterId",
                        column: x => x.DynamicParameterId,
                        principalTable: "DynamicParameters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationOfDepartureId = table.Column<int>(nullable: false),
                    LocationOfArrivalId = table.Column<int>(nullable: true),
                    JetId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Flights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Flights_Jets_JetId",
                        column: x => x.JetId,
                        principalTable: "Jets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Cities_LocationOfArrivalId",
                        column: x => x.LocationOfArrivalId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Cities_LocationOfDepartureId",
                        column: x => x.LocationOfDepartureId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "EntityDynamicParameterValues",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntityDynamicParameterValues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntityDynamicParameterValues_EntityDynamicParameters_EntityDynamicParameterId",
                        column: x => x.EntityDynamicParameterId,
                        principalTable: "EntityDynamicParameters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DynamicParameters_ParameterName_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DynamicParameterValues_DynamicParameterId",
                table: "DynamicParameterValues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntityDynamicParameters_DynamicParameterId",
                table: "EntityDynamicParameters",
                column: "DynamicParameterId");

            migrationBuilder.CreateIndex(
                name: "IX_EntityDynamicParameters_EntityFullName_DynamicParameterId_TenantId",
                table: "EntityDynamicParameters",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntityDynamicParameterValues_EntityDynamicParameterId",
                table: "EntityDynamicParameterValues",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_JetId",
                table: "Flights",
                column: "JetId");

            migrationBuilder.CreateIndex(
                name: "IX_Flights_LocationOfArrivalId",
                table: "Flights",
                column: "LocationOfArrivalId");

            migrationBuilder.CreateIndex(
                name: "IX_Flights_LocationOfDepartureId",
                table: "Flights",
                column: "LocationOfDepartureId");
