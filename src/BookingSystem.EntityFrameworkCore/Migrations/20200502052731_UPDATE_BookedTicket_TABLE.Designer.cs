...
namespace BookingSystem.Migrations
{
    ...
    [Migration("20200502052731_UPDATE_BookedTicket_TABLE")]
    partial class UPDATE_BookedTicket_TABLE
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.DynamicEntityParameters.DynamicParameterValue", b =>
                {
                    ...
                    b.ToTable("DynamicParameterValues");
                });
            ...
            modelBuilder.Entity("Abp.DynamicEntityParameters.EntityDynamicParameter", b =>
                {
                    ...
                    b.ToTable("EntityDynamicParameters");
                });
            ...
            modelBuilder.Entity("Abp.DynamicEntityParameters.EntityDynamicParameterValue", b =>
                {
                    ...
                    b.ToTable("EntityDynamicParameterValues");
                });
            ...
            modelBuilder.Entity("BookingSystem.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingSystem.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BookingSystem.Cities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingSystem.Flights.Flight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("LocationOfArrivalId")
                        .HasColumnType("int");

                    b.Property<int>("LocationOfDepartureId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LocationOfArrivalId");

                    b.HasIndex("LocationOfDepartureId");

                    b.ToTable("Flights");
                });

            modelBuilder.Entity("BookingSystem.Jets.Jet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookingSystem.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BookingSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BookingSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("BookingSystem.Authorization.Roles.Role", b =>
                {
                    b.HasOne("BookingSystem.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("BookingSystem.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("BookingSystem.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BookingSystem.Flights.Flight", b =>
                {
                    b.HasOne("BookingSystem.Jets.Jet", "JetFk")
                        .WithMany()
                        .HasForeignKey("JetId");

                    b.HasOne("BookingSystem.Cities.City", "LocationOfArrivalFk")
                        .WithMany()
                        .HasForeignKey("LocationOfArrivalId");

                    b.HasOne("BookingSystem.Cities.City", "LocationOfDepartureFk")
                        .WithMany()
                        .HasForeignKey("LocationOfDepartureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
