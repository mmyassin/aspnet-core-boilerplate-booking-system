(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/Flights/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Flights/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditFlightModal'
        });

		 var _viewFlightModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/Flights/ViewflightModal',
        ...
        var dataTable = _$flightsTable.DataTable({
            ...
            listAction: {
                ...
                inputFilter: function () {
					...
					minDepartureDateFilter:  getDateFilter($('#MinDepartureDateFilterId')),
					maxDepartureDateFilter:  getDateFilter($('#MaxDepartureDateFilterId')),
					minArrivalDateFilter:  getDateFilter($('#MinArrivalDateFilterId')),
					maxArrivalDateFilter:  getDateFilter($('#MaxArrivalDateFilterId')),
