(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/Jets/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/App/Views/Jets/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditJetModal'
        });

		 var _viewJetModal = new app.ModalManager({
            viewUrl: abp.appPath + 'App/Jets/ViewjetModal',
