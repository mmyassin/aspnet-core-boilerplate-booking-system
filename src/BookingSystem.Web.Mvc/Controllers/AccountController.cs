...
using BookingSystem.Web.Models.Account;
using BookingSystem.Web.Views.Shared.Components.TenantChange;

namespace BookingSystem.Web.Controllers
{
    public class AccountController : BookingSystemControllerBase
    {
